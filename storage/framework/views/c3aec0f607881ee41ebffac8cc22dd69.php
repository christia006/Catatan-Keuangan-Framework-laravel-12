    ...
    <div class="col-md-4">
        <div class="card shadow-sm border-0 bg-gradient" style="background: linear-gradient(45deg, #00b09b, #96c93d);">
            <div class="card-body p-4">
                ...
                <h3 class="mb-0 text-white">Rp <?php echo e(number_format($totalIncome ?? 0, 0, ',', '.')); ?></h3>
                <div class="mt-3 text-white-50">
                    <small>Periode: <?php echo e(now()->format('F Y')); ?></small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card shadow-sm border-0 bg-gradient" style="background: linear-gradient(45deg, #FF416C, #FF4B2B);">
            <div class="card-body p-4">
                ...
                <h3 class="mb-0 text-white">Rp <?php echo e(number_format($totalExpense ?? 0, 0, ',', '.')); ?></h3>
                <div class="mt-3 text-white-50">
                    <small>Periode: <?php echo e(now()->format('F Y')); ?></small>
                </div>
            </div>
    ...
    <div class="col-md-4">
        <div class="card shadow-sm border-0 bg-gradient" style="background: linear-gradient(45deg, #2193b0, #6dd5ed);">
            <div class="card-body p-4">
                ...
                <h3 class="mb-0 text-white">Rp <?php echo e(number_format(($totalIncome ?? 0) - ($totalExpense ?? 0), 0, ',', '.')); ?></h3>
                <div class="mt-3 text-white-50">
                    <small>Update Terakhir: <?php echo e(now()->format('d M Y H:i')); ?></small>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\Users\ASUS\OneDrive\Pictures\CatatanKeuangan\resources\views/components/cards/statistics.blade.php ENDPATH**/ ?>